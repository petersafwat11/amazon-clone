      ...
      <div>
        <form className='space-y-4' onSubmit={handleSubmit(formHandeler)}>
            ...
            <div className='flex flex-col'>
                ...
                })} id='confirm' className='w-full p-3 my-2 rounded shadow border outline-none ring-indigo-300 focus:ring '/>
            ...
            <div className='flex flex-col'>
                <button className='primary-button'> updata profile</button>
            </div>
        </form>
      </div>
    </div>
